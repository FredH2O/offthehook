  ...
  return (
    <div className="flex flex-col justify-center items-center space-y-5">
      ...
      <button
        ...
        className="px-3 py-1 border hover:cursor-pointer transition-all duration-75 active:translate-y-0.5 text-black active:bg-blue-500/50 bg-blue-500 rounded-sm"
      >
        Randomize My Perks
      </button>
    </div>
